...
export const manualChestLiftWithLegLift: ExerciseRecord = {
  display: {
    id: "manual-chest-lift-with-leg-lift",
    slug: "manual-chest-lift-with-leg-lift",
    name: "Chest Lift with Leg Lift",
  ...
  source: {
    ...
    page: 16,
    section: "Supine",
    originalName: "Chest Lift with Leg Lift",
