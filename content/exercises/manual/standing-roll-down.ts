...
export const manualStandingRollDown: ExerciseRecord = {
  display: {
    id: "manual-standing-roll-down",
    slug: "manual-standing-roll-down",
  ...
  source: {
    ...
    originalName: "Standing Roll Down",
  ...
  anatomy: {
    ...
    primaryMuscleIds: ["transversus-abdominis", "multifidus", "glutes"],
    stabilizerMuscleIds: [],
    regions: ["Deep Core", "Posterior Chain"],
    bodyScanFocus: ["Feet and ankles", "Knees", "Pelvis", "Rib cage"],
    overlay: {
      primary: ["transversus-abdominis", "multifidus", "glutes"],
      secondary: [],
      stabilizers: [],
      preferredView: "both"
    }
