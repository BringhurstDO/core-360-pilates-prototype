...
export const manualStandingSideBend: ExerciseRecord = {
  display: {
    id: "manual-standing-side-bend",
    slug: "manual-standing-side-bend",
  ...
  source: {
    ...
    originalName: "Standing Side Bend",
  ...
  anatomy: {
    ...
    primaryMuscleIds: ["transversus-abdominis", "multifidus", "obliques", "glutes"],
    stabilizerMuscleIds: [],
    regions: ["Deep Core", "Anterior Core", "Posterior Chain", "Lateral System"],
    bodyScanFocus: ["Feet and ankles", "Knees", "Pelvis", "Rib cage"],
    overlay: {
      primary: ["transversus-abdominis", "multifidus", "obliques", "glutes"],
      secondary: [],
      stabilizers: [],
      preferredView: "both"
    }
