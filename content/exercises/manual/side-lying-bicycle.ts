...
export const manualSideLyingBicycle: ExerciseRecord = {
  display: {
    id: "manual-side-lying-bicycle",
    slug: "manual-side-lying-bicycle",
    name: "Side-Lying Bicycle",
  ...
  source: {
    ...
    page: 39,
    section: "Side-Facing",
    originalName: "Side-Lying Bicycle",
