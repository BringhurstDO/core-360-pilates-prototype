...
export const manualSideLyingDeveloppe: ExerciseRecord = {
  display: {
    id: "manual-side-lying-developpe",
    slug: "manual-side-lying-developpe",
    name: "Side-Lying Developpé",
  ...
  source: {
    ...
    page: 41,
    section: "Side-Facing",
    originalName: "Side-Lying Developpé",
