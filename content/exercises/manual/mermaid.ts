...
,
  media: {
    teachingDiagram: {
      id: "manual-mermaid-teaching",
      title: "Mermaid",
      description: "Generated muscle-emphasis teaching diagram for Mermaid.",
      poseNotes: [],
      annotationLabels: [],
      kind: "uploaded",
      imageSrc: "/teaching-diagrams/manual-mermaid.png",
      imageAlt: "Mermaid teaching diagram with highlighted muscles"
    }
  }
};
