...
export const manualSideLyingFrontBackKick: ExerciseRecord = {
  display: {
    id: "manual-side-lying-front-back-kick",
    slug: "manual-side-lying-front-back-kick",
    name: "Side-Lying Front / Back Kick",
