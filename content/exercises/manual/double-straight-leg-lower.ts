...
export const manualDoubleStraightLegLower: ExerciseRecord = {
  display: {
    id: "manual-double-straight-leg-lower",
    slug: "manual-double-straight-leg-lower",
  ...
  source: {
    ...
    page: 22,
    section: "Supine",
    originalName: "Double Straight Leg Lower",
