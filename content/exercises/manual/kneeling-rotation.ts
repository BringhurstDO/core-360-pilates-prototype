...
export const manualKneelingRotation: ExerciseRecord = {
  display: {
    id: "manual-kneeling-rotation",
    slug: "manual-kneeling-rotation",
    name: "Kneeling Rotation",
  ...
  source: {
    ...
    originalName: "Kneeling Rotation",
