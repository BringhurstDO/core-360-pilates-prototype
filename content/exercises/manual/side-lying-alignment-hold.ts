...
export const manualSideLyingAlignmentHold: ExerciseRecord = {
  display: {
    id: "manual-side-lying-alignment-hold",
    slug: "manual-side-lying-alignment-hold",
    name: "Side-Lying Alignment Hold",
  ...
  source: {
    ...
    page: 34,
    section: "Side-Facing",
    originalName: "Side-Lying Alignment Hold",
