...
export const manualSideLyingLegBeats: ExerciseRecord = {
  display: {
    id: "manual-side-lying-leg-beats",
    slug: "manual-side-lying-leg-beats",
    name: "Side-Lying Leg Beats",
  ...
  source: {
    ...
    page: 43,
    section: "Side-Facing",
    originalName: "Side-Lying Leg Beats",
