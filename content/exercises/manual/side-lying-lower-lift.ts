...
export const manualSideLyingLowerLift: ExerciseRecord = {
  display: {
    id: "manual-side-lying-lower-lift",
    slug: "manual-side-lying-lower-lift",
    name: "Side-Lying Lower Lift",
  ...
  source: {
    ...
    page: 36,
    section: "Side-Facing",
    originalName: "Side-Lying Lower Lift",
