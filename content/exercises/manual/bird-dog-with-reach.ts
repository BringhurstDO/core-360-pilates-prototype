...
export const manualBirdDogWithReach: ExerciseRecord = {
  display: {
    id: "manual-bird-dog-with-reach",
    slug: "manual-bird-dog-with-reach",
  ...
  source: {
    ...
    originalName: "Bird Dog with Reach",
  ...
  anatomy: {
    ...
    primaryMuscleIds: ["transversus-abdominis", "multifidus", "glutes", "shoulder-stabilizers"],
    stabilizerMuscleIds: [],
    regions: ["Deep Core", "Posterior Chain", "Shoulder Stabilizers"],
    bodyScanFocus: ["Pelvis", "Rib cage", "Shoulder girdle", "Wrist/hand support"],
    overlay: {
      primary: ["transversus-abdominis", "multifidus", "glutes", "shoulder-stabilizers"],
      secondary: [],
      stabilizers: [],
      preferredView: "both"
    }
